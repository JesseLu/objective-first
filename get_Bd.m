function [B, d] = get_Ab(omega, E, dims, b)
...
diag_E = spdiags(E(:), 0, numel(E), numel(E));
[eps_x, eps_y, A_spread] = ...
    ob1_interp_eps(sparse(dims(1), dims(2))); % Obtain x- and y- components of eps.
% This is the matrix that we will solve.
d = - Hcurl * Ecurl * E + b;
B = - omega^2 * diag_E * A_spread;
